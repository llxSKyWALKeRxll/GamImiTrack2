...
class Sprites:
    def __init__(self):
        self.sprites_category = {
            'dbz1': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\sonGoku.png').convert_alpha(),
            'dbz2': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\goku3.png').convert_alpha(),
            'dbz3': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\gohan1.png').convert_alpha(),
            'dbz4': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\goku8.png').convert_alpha(),
            'dbz5': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\goku9.png').convert_alpha(),
            'dbz6': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\vegeta1.png').convert_alpha(),
            'dbz7': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\vegeta2.png').convert_alpha(),
            'dbz8': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\trunks1.png').convert_alpha(),
            'dbz9': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\trunks2.png').convert_alpha(),
            'dbz10': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\picollo1.png').convert_alpha(),
            #'soldier': [pygame.image.load(rf'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Self Havoc\images\sprites\moving\{i}.png').convert_alpha for i in range(8)],
            #'cod1': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\cod1.png').convert_alpha(),
            'catW': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\catWelcome.png').convert_alpha(),
            'catS': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\catSelfie.png').convert_alpha(),
            'cb1': pygame.image.load(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Images\sprites\bheem1.png').convert_alpha(),
        }
