...
class FlashArtCol:
    def __init__(self, vid_path, font_size=8, colour_lvl = 16):
        ...
        self.font = pygame.font.SysFont(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\fonts\f2.ttf', font_size, bold=True)
    ...
    def load_image(self):
        ...
        if not temp:
            f1 = FlashArtCol(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\Videos\hagler1.mp4')
            f1.execute()
    ...
    def save_image(self):
        ...
        cv2.imwrite(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\output\Coloured_Flash_Art_Screenshot.png', cv_image)
...
#flash_art = FlashArtCol('C:\\Users\\rebor\\Desktop\\Academics 2k21\\Group Project 2k21\\Flash Art\\VideoCol_FlashArt_ASCII\\FlashArt_VideosCol\\hagler1.mp4')
#flash_art.execute()