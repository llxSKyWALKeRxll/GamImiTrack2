...
class mainImageManipulation: #This class will perform the main manipulation operations on the loaded image
    def __init__(self, imiManip, charSize = 5):
        ...
        self.image = self.load_image(r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\images\hagler3.jpg')
        #self.flag = 0
                ...
                if char:
                    ...
                    if red and green and blue: #if red/green/blue have a value, else no need to saturate or adjust the brightness of the pixelated array, else it will be left blank (because value goes into underscope)
                        ...
                        if keys[pygame.K_SPACE]:
                            ...
                            print('Saving image')
                            #self.take_screenshot()
                            pygame.image.save(self.imiManip.screen, r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\output\Manipulated_Image.png')
                            break
                            #self.take_screenshot()
                            #self.take_screenshot()
                            #pass
    ...
    def take_screenshot(self):
        save_image = pygame.image.save(self.imiManip.screen, r'C:\Users\rebor\Desktop\Academics 2k21\Group Project 2k21\Combined2\output\Filtered_Image.png')
        return
